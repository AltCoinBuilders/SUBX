...
const string strMessageMagic = "SUBX Signed Message:\n";
...
{
    int64_t nSubsidy = nCoinAge * 33 / (365 * 33 + 8) * (75 * CENT); // 75% Forever
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SUBX", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "SubTradeX is born on 27-11-2019.";
        CTransaction txNew;
        txNew.nTime = 1574875369;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1574875369;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1238162 : 1238162;
        ...
        assert(block.hashMerkleRoot == uint256("0x5ac46e3682bdd98be091b9ea6619e86780aaec206565b48bf9d5084c4587dae0"));
...
unsigned char pchMessageStart[4] = { 0x9b, 0xd3, 0x15, 0xe9 };
