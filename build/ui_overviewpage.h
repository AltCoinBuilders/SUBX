...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        labelBalance->setStyleSheet(QString::fromUtf8("QLabel { color: white; }"));
        labelBalance->setCursor(QCursor(Qt::IBeamCursor));
        labelBalance->setText(QString::fromUtf8("0 SUBX"));
        ...
        label_6->setStyleSheet(QString::fromUtf8("QLabel { color: white; }"));
        ...
        labelStake->setStyleSheet(QString::fromUtf8("QLabel { color: white; }"));
        labelStake->setCursor(QCursor(Qt::IBeamCursor));
        labelStake->setText(QString::fromUtf8("0 SUBX"));
        ...
        label_3->setStyleSheet(QString::fromUtf8("QLabel { color: white; }"));
        ...
        labelUnconfirmed->setStyleSheet(QString::fromUtf8("QLabel { color: white; }"));
        labelUnconfirmed->setCursor(QCursor(Qt::IBeamCursor));
        labelUnconfirmed->setText(QString::fromUtf8("0 SUBX"));
        ...
        labelImmatureText->setStyleSheet(QString::fromUtf8("QLabel { color: white; }"));
        ...
        labelImmature->setStyleSheet(QString::fromUtf8("QLabel { color: white; }"));
        labelImmature->setText(QString::fromUtf8("0 SUBX"));
        ...
        labelTotalText->setStyleSheet(QString::fromUtf8("QLabel { color: white; }"));
        ...
        labelTotal->setStyleSheet(QString::fromUtf8("QLabel { color: white; }"));
        ...
        label_4->setStyleSheet(QString::fromUtf8("QLabel { color: white; }"));
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the SUBX network after a connection is established, but this process has not completed yet.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the SUBX network after a connection is established, but this process has not completed yet.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
