...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "SUBX - Debug window", 0, QApplication::UnicodeUTF8));
        label_9->setText(QApplication::translate("RPCConsole", "SUBX Core", 0, QApplication::UnicodeUTF8));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the SUBX debug log file from the current data directory. This can take a few seconds for large log files.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the SUBX-Qt help message to get a list with possible SUBX command-line options.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
